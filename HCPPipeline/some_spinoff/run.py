...
def run_freesurfer(**args):
    ...
    if not os.path.exists(os.path.join(args["subjectDIR"], "fsaverage")):
         #print(os.path.join(os.environ["SUBJECTS_DIR"], "fsaverage") + '-to-' + os.path.join(args["subjectDIR"], "fsaverage"))
         copy_tree(os.path.join(os.environ["SUBJECTS_DIR"], "fsaverage"),os.path.join(args["subjectDIR"], "fsaverage"))
    if not os.path.exists(os.path.join(args["subjectDIR"], "lh.EC_average")):
         #print(os.path.join(os.environ["SUBJECTS_DIR"], "lh.EC_average") + '-to-' +  os.path.join(args["subjectDIR"], "lh.EC_average"))
         copy_tree(os.path.join(os.environ["SUBJECTS_DIR"], "lh.EC_average"),os.path.join(args["subjectDIR"], "lh.EC_average"))
    if not os.path.exists(os.path.join(args["subjectDIR"], "rh.EC_average")):
         copy_tree(os.path.join(os.environ["SUBJECTS_DIR"], "rh.EC_average"),os.path.join(args["subjectDIR"], "rh.EC_average"))

    run(cmd, cwd=args["path"], env={"NSLOTS": str(args["n_cpus"]),"OMP_NUM_THREADS": str(args["n_cpus"])})
